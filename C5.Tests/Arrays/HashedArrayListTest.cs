...
namespace C5.Tests.arrays.hashed
{
    ...
    public class GenericTesters
    {
        ...
        {
            static HashedArrayList<int> factory() => new(TenEqualityComparer.Default);
         ...
         new CollectionEvent<int>(EventType.Changed, new EventArgs(), list)
          ...
          new CollectionEvent<int>(EventType.Changed, new EventArgs(), list)});
            ...
            public void AddAll()
            {
                ...
                Listen();
                list.AddAll(new int[] { 145, 56, 167 });
                seen.Check(new CollectionEvent<int>[] {
    ...
    namespace CollectionOrSink
    {
        ...
        public class CollectionOrSink
        {
            ...
            public void AddAll()
            {
                ...
                var list2 = new HashedArrayList<int>();
    ...
    namespace IList
    {
        ...
        public class Searching
        {
            ...
            {
                var pairlist = new HashedArrayList<SCG.KeyValuePair<int, int>>(new KeyValuePairEqualityComparer<int, int>())
                {
                    new(10, 50),
                    new(11, 51),
                    new(12, 52),
    ...
    namespace View
    {
        ...
        public class Simple
        {
            ...
            public void Add()
            {
                ...
                var lst2 = new HashedArrayList<int>
                {
                    90,
                    92
                };
            ...
            public void Remove()
            {
                ...
                var l2 = new HashedArrayList<int>
                {
                    1,
                    2,
                    2,
