...
namespace C5.Tests.arrays.list
{
    ...
    public class GenericTesters
    {
        ...
        {
            static ArrayList<int> factory() => new(TenEqualityComparer.Default);
    ...
    namespace View
    {
        ...
        public class Simple
        {
            ...
            public void Add()
            {
                ...
                var lst2 = new ArrayList<int> { 90, 92 };
                view.AddAll(lst2);
                Check();
            ...
            public void Remove()
            {
                ...
                var l2 = new ArrayList<int>() { 1, 2, 2, 3, 1 };
        ...
        public class MulipleViews
        {
            ...
            {
                var list2 = new ArrayList<int>() { 1, 3, 4 };
            ...
            public void RetainAll()
            {
                var list2 = new ArrayList<int>() { 2, 4, 5 };
            ...
            public void RemoveAllCopies()
            {
                var list2 = new ArrayList<int> { 0, 2, 2, 2, 5, 2, 1 };
