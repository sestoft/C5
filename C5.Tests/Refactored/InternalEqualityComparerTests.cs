...
internal class InternalEqualityComparerTests
{
    [Test]
    public void Equals_given_null_and_null_returns_true()
    {
        var comparer = new InternalEqualityComparer<string>(StringComparer.InvariantCultureIgnoreCase.Equals, StringComparer.InvariantCultureIgnoreCase.GetHashCode);
