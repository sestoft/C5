...
public class ComparerZeroHashCodeEqualityComparerTests
{
    [Test]
    public void Equals_given_null_and_null_returns_true()
    {
        var comparer = new ComparerZeroHashCodeEqualityComparer<string>(System.StringComparer.InvariantCultureIgnoreCase);
