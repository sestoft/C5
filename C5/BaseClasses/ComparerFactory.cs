...
public static class ComparerFactory<T>
{
    ...
    public static SCG.IComparer<T> CreateComparer(Func<T, T, int> comparer)
    {
    ...
    public static SCG.IEqualityComparer<T> CreateEqualityComparer(Func<T, T, bool> equals, Func<T, int> getHashCode)
    {
