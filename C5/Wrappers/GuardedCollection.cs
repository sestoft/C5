...
public class GuardedCollection<T> : GuardedCollectionValue<T>, ICollection<T>
{
    ...
    /// </summary>
    /// <returns></returns>
    public virtual ICollectionValue<SCG.KeyValuePair<T, int>> ItemMultiplicities() { return new GuardedCollectionValue<SCG.KeyValuePair<T, int>>(collection.ItemMultiplicities()); }
    ...
    /// </summary>
    /// <value></value>
    public virtual SCG.IEqualityComparer<T> EqualityComparer => collection.EqualityComparer;
